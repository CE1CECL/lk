...
{
	return container_of_const(panel, struct hx8394d, panel);
}
...
static const struct drm_display_mode hx8394d_mode = {
	.clock = (540 + 52 + 24 + 100) * (960 + 8 + 4 + 20) * 60 / 1000,
	.hdisplay = 540,
	.hsync_start = 540 + 52,
	.hsync_end = 540 + 52 + 24,
	.htotal = 540 + 52 + 24 + 100,
	.vdisplay = 960,
	.vsync_start = 960 + 8,
	.vsync_end = 960 + 8 + 4,
	.vtotal = 960 + 8 + 4 + 20,
...
MODULE_DESCRIPTION("DRM driver for hx8394d qhd video mode dsi panel");
MODULE_LICENSE("GPL");
